...
namespace {
    ...
    class Artisan extends \Illuminate\Support\Facades\Artisan{
        ...
        public static function handle($input, $output = null){
            ...
            return \ChaoticWave\LeakyThoughts\Console\Kernel::handle($input, $output);
        }
        ...
        public static function terminate($input, $status){
            //Method inherited from \Illuminate\Foundation\Console\Kernel            
            \ChaoticWave\LeakyThoughts\Console\Kernel::terminate($input, $status);
        }
        ...
        public static function command($signature, $callback){
            //Method inherited from \Illuminate\Foundation\Console\Kernel            
            return \ChaoticWave\LeakyThoughts\Console\Kernel::command($signature, $callback);
        }
        ...
        public static function registerCommand($command){
            //Method inherited from \Illuminate\Foundation\Console\Kernel            
            \ChaoticWave\LeakyThoughts\Console\Kernel::registerCommand($command);
        }
        ...
        public static function call($command, $parameters = array()){
            //Method inherited from \Illuminate\Foundation\Console\Kernel            
            return \ChaoticWave\LeakyThoughts\Console\Kernel::call($command, $parameters);
        }
        ...
        public static function queue($command, $parameters = array()){
            //Method inherited from \Illuminate\Foundation\Console\Kernel            
            \ChaoticWave\LeakyThoughts\Console\Kernel::queue($command, $parameters);
        }
        ...
        public static function all(){
            //Method inherited from \Illuminate\Foundation\Console\Kernel            
            return \ChaoticWave\LeakyThoughts\Console\Kernel::all();
        }
        ...
        public static function output(){
            //Method inherited from \Illuminate\Foundation\Console\Kernel            
            return \ChaoticWave\LeakyThoughts\Console\Kernel::output();
        }
        ...
        public static function bootstrap(){
            //Method inherited from \Illuminate\Foundation\Console\Kernel            
            \ChaoticWave\LeakyThoughts\Console\Kernel::bootstrap();
        }
        ...
        public static function setArtisan($artisan){
            //Method inherited from \Illuminate\Foundation\Console\Kernel            
            \ChaoticWave\LeakyThoughts\Console\Kernel::setArtisan($artisan);
        }
    ...
    class Auth extends \Illuminate\Support\Facades\Auth{
         ...
         *
         * @return \ChaoticWave\LeakyThoughts\User|null
         * @static 
         */
         ...
         * @param mixed $id
         * @param bool $remember
         * @return \ChaoticWave\LeakyThoughts\User|false
         * @static 
         */
         ...
         *
         * @return \ChaoticWave\LeakyThoughts\User
         * @static 
         */
